...
__export(index_exports, {
  DEFAULT_AUDIENCE_OPTIONS: () => DEFAULT_AUDIENCE_OPTIONS,
  DEFAULT_PRIORITY_DOMAINS: () => DEFAULT_PRIORITY_DOMAINS,
  DEFAULT_SCOPE_OPTIONS: () => DEFAULT_SCOPE_OPTIONS,
  DIFFICULTY_PRESETS: () => DIFFICULTY_PRESETS,
  TAB_PRESETS: () => TAB_PRESETS,
  createConfig: () => createConfig,
  generate: () => generate,
  generatePrompt: () => generatePrompt,
  generatePromptFromConfig: () => generatePromptFromConfig,
  generateSearchQueries: () => generateSearchQueries,
  generateSearchQueriesFromConfig: () => generateSearchQueriesFromConfig,
  getDifficultyPreset: () => getDifficultyPreset,
  getTabPreset: () => getTabPreset
});
